  ...
  return (
    ...
    <Script
      ...
      <Script
        ...
        strategy="lazyOnload"  // Load script asynchronously
      />
    <section className="grid bg-purple-100 px-4 h-[500px] py-[57.2px] grid-cols-2 sectionquery">
    <div className=" flex flex-col gap-5 items-center pt-14 justify-center">
      <p className={`font-bold text-3xl  max-[430px]:text-2xl max-[800px]:text-center ${poppins.className}`}>The best URL shortner in the Market.</p>
      <p className="font-medium text-center  max-[430px]:text-sm max-[440px]:px-4 px-16">We are the most straight forward URL shortner in the world ever. Our service is designed to be simple and efficient, allowing you to shorten URLs quickly and easily and efficiently by this amazing thing.</p>
     <div className="my-2 justify-start flex font-extrabold text-2xl  max-[430px]:text-xl"><p className="opacity-0">sasd</p><span className="relative right-6" id="element"></span></div>
    ...
    <div className="relative flex justify-center cecc h-[456px]">
      <Image src={"/vector.avif"} fill={true} alt="an image of a vector"/>
    </div>
    </section>

    <section className="bg-purple-100 h-[400px]">
      <h1 className="font-extrabold text-3xl text-center  max-[430px]:text-2xl pt-4">Leave a Comment..</h1>
...
<p className="ms-auto text-xs text-gray-500 dark:text-gray-400">Remember, contributions to this topic should follow our <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline">Community Guidelines</a>.</p>
    ...
    <footer className="flex justify-between items-center bg-black p-5  max-[430px]:px-4 px-10">
      <h2 className="font-bold text-2xl  max-[430px]:text-xl text-white">Linkify</h2>
