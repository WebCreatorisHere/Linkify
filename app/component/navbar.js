...
const navbar = () => {
  return (
    <nav className='h-16 bg-purple-700 flex items-center justify-between px-10 text-white'>
      <div className="logo font-bold text-2xl">Linkify</div>
      <ul className='flex items-center justify-center gap-6'>
        <li><Link prefetch={true} href="/">Home</Link></li>
        <li><Link prefetch={true} href="/about">About</Link></li>
        <li><Link prefetch={true} href="/shortern">Generate</Link></li>
